...
class DirectorPatchTest extends TestCase
{
    ...
    public function test_patch_directors_200(): void
    {
        ...
        $response = $this->patch('/api/v1/directors/44', $directorsData);
    ...
    public function test_patch_directors_422_byInvalid(): void
    {
        $directorsData = [
        ...
        $response = $this->patch('/api/v1/directors/48', $directorsData);
    ...
    public function test_patch_directors_404_byId(): void
    {
        $directorsData = [
        ...
        $response = $this->patch('/api/v1/directors/1000', $directorsData);
