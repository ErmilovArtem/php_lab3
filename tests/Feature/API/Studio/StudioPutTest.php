...
class StudioPutTest extends TestCase
{
    ...
    public function test_put_studio_200(): void
    {
        ...
        $response = $this->put('/api/v1/studios/44', $studioData);
    ...
    public function test_put_studio_422_byInvalid(): void
    {
        $studioData = [
            'name' => 'My Studio Test',
            'year_of_foundation' => "2000-01-01",
        ...
        $response = $this->put('/api/v1/studios/48', $studioData);
    ...
    public function test_put_studio_404_byId(): void
    {
        $studioData = [
        ...
        $response = $this->put('/api/v1/studios/1000', $studioData);
